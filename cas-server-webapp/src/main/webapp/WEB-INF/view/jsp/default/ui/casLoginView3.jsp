...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/bower_components/angular-motion/dist/angular-motion.min.css" /> "/>
    <link rel="stylesheet" href="<c:url value="/resources/bower_components/bootstrap-additions/dist/bootstrap-additions.min.css" /> "/>
    <link rel="stylesheet" href="<c:url value="/resources/bower_components/angular-loading-bar/build/loading-bar.min.css" /> ">
    <link rel="stylesheet" href="<c:url value="/resources/bower_components/toastr/toastr.min.css" /> ">

    <link rel="stylesheet" href="<c:url value="/resources/styles/cloud/cloud.css" />">
    <!-- ================== BEGIN CLOUD CSS STYLE ================== -->
